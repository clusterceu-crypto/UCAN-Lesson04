(() => {
  ...
  function buildAiPrompt(mode, data) {
    ...
    const modeInstructions = {
      advice: 'Поясніть простими словами, що в цій Карті адаптації варто уточнити насамперед. Наведіть один короткий умовний приклад, але не вигадуйте фактів про громаду і не переписуйте роботу замість користувача. Завершіть одним запитанням, яке допоможе користувачу самостійно покращити результат.',
